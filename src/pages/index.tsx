  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Tasky4: Your Personal Assistant for Efficient Task Management. Simplify, Organize, and Prioritize Your To-Do Lists, All in One Place."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Tasky4: Your Personal Assistant for Efficient Task Management. Simplify, Organize, and Prioritize Your To-Do Lists, All in One Place.`}
            </Text>
            <Box
